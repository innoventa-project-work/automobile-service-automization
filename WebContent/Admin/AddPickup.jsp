...
<!--                <small>Add cities for user selection.</small> -->
            ...
            <div class="panel panel-default">
               ...
               <form method="post" action="<%=request.getContextPath()%>/pickupController" class="form-horizontal">
                     ...
                     <fieldset>
                        <div class="form-group">
                           <div class="col-sm-6 col-sm-offset-3">
                              ...
                              <input type="hidden" name="flag" value="insertPickup" />
