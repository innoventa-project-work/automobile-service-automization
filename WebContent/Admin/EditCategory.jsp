   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            <h3>Edit Category
               <br>
<!--                <small>Add countries for user selection.</small> -->
            </h3>
            <!-- START row-->
            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <form method="post" action="<%=request.getContextPath()%>/VehicleCategoryController" class="form-horizontal">
                  <c:forEach items="${sessionScope.categoryList}" var="j">
                     <fieldset>
                        <div class="form-group">
                           <label class="col-sm-2 control-label">Category Name</label>
                           <div class="col-sm-10">
                              <input type="text" value="${j.category}" name="categoryName" placeholder="Category Name" class="form-control">
                           </div>
                        </div>
                     </fieldset>
                     ...
                     <fieldset>
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <textarea name="categoryDescription" placeholder="Country Description" class="form-control">${j.categorydescription}</textarea>
                           </div>
                        </div>
                     </fieldset>
                        ...
                        <div class="form-group">
                           <div class="col-sm-6 col-sm-offset-3">
                              ...
                              <input type="hidden" name="flag" value="updateCategory">
                      		  <input type="hidden" name="categoryId" value="${j.vcid }">
