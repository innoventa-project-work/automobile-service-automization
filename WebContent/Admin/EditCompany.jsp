...
<!--                <small>Add states for user selection.</small> -->
            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <form method="post" action="<%=request.getContextPath()%>/companyController" class="form-horizontal">
                     <c:forEach items="${sessionScope.companyList}" var="j">
                      <fieldset>
                     ...
                     <fieldset>
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <input type="text" value="${j.companyName}" name="companyName" required="required" placeholder="State Name" class="form-control">
                           </div>
                        </div>
                     </fieldset>
                     ...
                     <fieldset>
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <textarea name="companyDescription" required="required"  placeholder="State Description" class="form-control">${j.companyDescription}</textarea>
                           </div>
                        </div>
                     </fieldset>
                     ...
                     <fieldset>
                        <div class="form-group">
                           <div class="col-sm-6 col-sm-offset-3">
                              ...
                              <input type="hidden" name="companyId" value="${j.comid }">
