...
<!--                <small>Add states for user selection.</small> -->
            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <form method="post" action="<%=request.getContextPath()%>/StateController" class="form-horizontal">
                     ...
                     <fieldset>
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <input type="text" value="${j.stateName}" name="stateName" required="required" placeholder="State Name" class="form-control">
                           </div>
                        </div>
                     </fieldset>
                     ...
                     <fieldset>
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <textarea name="stateDescription" required="required"  placeholder="State Description" class="form-control">${j.stateDescription}</textarea>
                           </div>
                        </div>
                     </fieldset>
