...
<!--                <small>Add countries for user selection.</small> -->
            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <form method="post" action="<%=request.getContextPath()%>/CountryController" class="form-horizontal">
                  <c:forEach items="${sessionScope.editcountryList}" var="j">
                     <fieldset>
                        <div class="form-group">
                           <label class="col-sm-2 control-label">Country Name</label>
                           <div class="col-sm-10">
                              <input type="text" value="${j.countryname}" name="countryName" placeholder="Country Name" class="form-control">
                           </div>
                        </div>
                     </fieldset>
                     ...
                     <fieldset>
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <textarea name="countryDescription" placeholder="Country Description" class="form-control">${j.countrydesc}</textarea>
                           </div>
                        </div>
                     </fieldset>
                        ...
                        <div class="form-group">
                           <div class="col-sm-6 col-sm-offset-3">
                              ...
                              <input type="hidden" name="flag" value="updateCountry">
                      		  <input type="hidden" name="id" value="${j.cid }">
