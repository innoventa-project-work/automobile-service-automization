               ...
               <form method="post" action="<%=request.getContextPath()%>/cityController" class="form-horizontal">
                     ...
                     <fieldset>
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <input type="text" value="${j.cityName}" name="cityName" required="required" placeholder="City Name" class="form-control">
                           </div>
                        </div>
                     </fieldset>
                     ...
                     <fieldset>
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <textarea name="cityDescription" required="required"  placeholder="City Description" class="form-control">${j.cityDescription}</textarea>
                           </div>
                        </div>
                     </fieldset>
