...
<!-- Loader end -->
  ...
  <jsp:include page="Menu.jsp"></jsp:include>
    ...
    <div id="sliderpro1" class="slider-pro main-slider">
          ...
          <div class="sp-slide"> <img class="sp-image" src="img/slider-gallery/1.jpg"
					data-src="img/slider-gallery/1.jpg"
					data-retina="img/slider-gallery/1.jpg" alt="img"/>
              ...
              <div class="main-slider__inner text-left">
               <div class="custom-caption"> <a class="main-slider__btn btn-effect" href="javascript:void(0);"><span class="main-slider__btn_inner">the all new</span></a>
            ...
            <div> <span class="main-slider__price">$35,290</span> <a class="main-slider__link" href="javascript:void(0);"><i class="icon fa fa-caret-right"></i></a> </div>
          </div>
            </div>
          </div>
         ...
         <div class="sp-slide"> <img class="sp-image" src="img/slider-gallery/2.jpg"
					data-src="img/slider-gallery/2.jpg"
					data-retina="img/slider-gallery/2.jpg" alt="img"/>
            ...
            <div class="decor-1"></div>
            <div class="main-slider__text">Starts from</div>
            <div> <span class="main-slider__price">$37,390</span> <a class="main-slider__link" href="javascript:void(0);"><i class="icon fa fa-caret-right"></i></a> </div>
          </div>
            </div>
          </div>
        </div>
    ...
    <section class="section_mod-a section-bg-2">
      <div class="bg-inner">
        <div class="container">
            ...
            <div class="col-xs-12">
              ...
              <div class="wrap-link-img">
                <ul class="link-img link-img_mod-a list-inline wow bounceInLeft" data-wow-duration="2s">
                  <li class="link-img__item"> <a class="link-img__link" href="javascript:void(0);"><img class="img-responsive" src="img/1.png" height="250" width="170" alt="Foto">
                    <div class="link-img__wrap-title"><span class="link-img__title">all brands</span></div>
                    </a> </li>
                  <li class="link-img__item"> <a class="link-img__link" href="javascript:void(0);"><img class="img-responsive" src="img/2.png" height="250" width="170" alt="Foto">
                ...
                <ul class="link-img link-img_mod-b list-inline wow bounceInRight" data-wow-duration="2s">
                  <li class="link-img__item"> <a class="link-img__link" href="javascript:void(0);"><img class="img-responsive" src="img/3.png" height="250" width="170" alt="Foto">
                    <div class="link-img__wrap-title"><span class="link-img__title">DEALERSHIP</span></div>
                    </a> </li>
                  <li class="link-img__item"> <a class="link-img__link" href="javascript:void(0);"><img class="img-responsive" src="img/4.png" height="250" width="170" alt="Foto">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 wow bounceInRight" data-wow-duration="2s" data-wow-delay="1s">
              ...
              <ul class="list-mark list-unstyled">
                <li> <i class="decor-3 fa fa-caret-right"></i>Maecenas mattis facilisis arcu Ised  Morbi accumsan dignissim sed libero lorem ipsum </li>
                <li> <i class="decor-3 fa fa-caret-right"></i>Phasellus eget nisl vel lacus ipsum diui proin rutrum turpis non nulla it amet consectetur </li>
                <li> <i class="decor-3 fa fa-caret-right"></i>Dhasellus consequat sed acda duia aliquam massa suspendisse porta do eiusmod tempa </li>
              </ul>
            </div>
            <!-- end col --> 
          </div>
          ...
          <div class="row">
            <div class="col-xs-12"> <a class="brand-link text-center wow bounceInUp" data-wow-duration="2s" data-wow-delay="1s" href="javascript:void(0);"><i class="icon fa fa-caret-right"></i>SEE LISTED VEHICLES<i class="icon fa fa-caret-left"></i><span class="br"></span>
              ...
              <div class="col-xs-12">
                ...
                <ul class="list-progress list-unstyled">
                  <li class="list-progress__item"> <i class="icon flaticon-transport391"></i>
                    <div class="list-progress__inner"> <span class="chart" data-percent="900"><span class="percent"></span>+</span> <span class="list-progress__name">COUNTRIES REACHED</span> </div>
                  </li>
                  <li class="list-progress__item"> <i class="icon flaticon-automobile8"></i>
                    <div class="list-progress__inner"> <span class="chart" data-percent="10000"><span class="percent"></span>+</span> <span class="list-progress__name">PASSED GRADUATES</span> </div>
                  </li>
                  <li class="list-progress__item"> <i class="icon flaticon-bus6"></i>
                    <div class="list-progress__inner"> <span class="chart" data-percent="120"><span class="percent"></span>+</span> <span class="list-progress__name">QUALIFIED STAFF</span> </div>
                  </li>
                </ul>
                <!-- end list-progress --> 
              </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-5">
              ...
              <div class="decor-1"></div>
              <a class="link" href="javascript:void(0);">we deal in all kinds of brands & vehicles</a> </div>
            <!-- end col --> 
          </div>
          <!-- end row --> 
        </div>
            ...
            <div class="col-xs-12">
              ...
              <ul class="list-brands list-inline">
                <li class="list-brands__item">
                  <div class="list-brands__inner"><img class="list-brands__img img-responsive" src="img/brand-8.jpg" height="57" width="250" alt="Brand"></div>
                </li>
                <li class="list-brands__item">
                  <div class="list-brands__inner"><img class="list-brands__img img-responsive" src="img/brand-4.jpg" height="57" width="250" alt="Brand"></div>
                </li>
                <li class="list-brands__item">
                  <div class="list-brands__inner"><img class="list-brands__img img-responsive" src="img/brand-7.jpg" height="57" width="250" alt="Brand"></div>
                </li>
                <li class="list-brands__item">
                  <div class="list-brands__inner"><img class="list-brands__img img-responsive" src="img/brand-1.jpg" height="57" width="250" alt="Brand"></div>
                </li>
                <li class="list-brands__item">
                  <div class="list-brands__inner"><img class="list-brands__img img-responsive" src="img/brand-5.jpg" height="57" width="250" alt="Brand"></div>
                </li>
              </ul>
            </div>
            <!-- end col --> 
          ...
          <div class="col-xs-12">
            ...
            <ul class="list-staff list-unstyled">
              <li class="list-staff__item clearfix">
                <div class="list-staff__media"> <img class="img-responsive" src="img/team1.jpg" height="280" width="280" alt="foto">
              ...
              <li class="list-staff__item clearfix">
                <div class="list-staff__media"> <img class="img-responsive" src="img/team3.jpg" height="280" width="280" alt="foto">
                  <ul class="list-staff__social list-inline">
                    <li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
                    <li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
                    <li><a class="icon fa fa-google-plus" href="javascript:void(0);"></a></li>
                ...
                <div class="list-staff__inner">
                  ...
                  <div class="staff-progress">
                    <div class="staff-progress__title"><i class="decor-3 fa fa-caret-right"></i>SKILL LEVEL</div>
                    <div class="progress progress-striped active">
                      <div class="progress-bar"  role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 75%"> <span class="sr-only">45% Complete</span> </div>
                    </div>
                  </div>
                </div>
                <!-- end list-staff__inner --> 
              ...
              <li class="list-staff__item clearfix">
                <div class="list-staff__media"> <img class="img-responsive" src="img/team2.jpg" height="280" width="280" alt="foto">
                  <ul class="list-staff__social list-inline">
                    <li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
                    <li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
                    <li><a class="icon fa fa-google-plus" href="javascript:void(0);"></a></li>
                ...
                <div class="list-staff__inner">
                  ...
                  <div class="staff-progress">
                    <div class="staff-progress__title"><i class="decor-3 fa fa-caret-right"></i>SKILL LEVEL</div>
                    <div class="progress progress-striped active">
                      <div class="progress-bar"  role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 90%"> <span class="sr-only">45% Complete</span> </div>
                    </div>
                  </div>
                </div>
                <!-- end list-staff__inner --> 
              ...
              <li class="list-staff__item clearfix">
                <div class="list-staff__media"> <img class="img-responsive" src="img/team4.jpg" height="280" width="280" alt="foto">
                  <ul class="list-staff__social list-inline">
                    <li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
                    <li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
                    <li><a class="icon fa fa-google-plus" href="javascript:void(0);"></a></li>
                ...
                <div class="list-staff__inner">
                  ...
                  <div class="staff-progress">
                    <div class="staff-progress__title"><i class="decor-3 fa fa-caret-right"></i>SKILL LEVEL</div>
                    <div class="progress progress-striped active">
                      <div class="progress-bar"  role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 40%"> <span class="sr-only">40% Complete</span> </div>
                    </div>
                  </div>
                </div>
                <!-- end list-staff__inner --> 
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="slider-gallery owl-carousel owl-theme owl-theme_mod-a enable-owl-carousel"
														...
														data-navigation="false"
														data-stop-on-hover="true">
                  <div class="slider-gallery__item"> <a class="slider-gallery__link" href="img/car1.jpg" rel="prettyPhoto"> <img class="" src="img/car1.jpg" height="177" width="280" alt="foto">
                    <div class="slider-gallery__hover"> <i class="icon icon-magnifier-add"></i>
                      <div class="slider-gallery__title">AUDI ABT S6</div>
                    </div>
                    </a> </div>
                  <div class="slider-gallery__item"> <a class="slider-gallery__link" href="img/car2.jpg" rel="prettyPhoto"> <img class="img-responsive" src="img/car2.jpg" height="177" width="280" alt="foto">
                    <div class="slider-gallery__hover"> <i class="icon icon-magnifier-add"></i>
                      <div class="slider-gallery__title">AUDI ABT S6</div>
                    </div>
                    </a> </div>
                  <div class="slider-gallery__item"> <a class="slider-gallery__link" href="img/car3.jpg" rel="prettyPhoto"> <img class="img-responsive" src="img/car3.jpg" height="177" width="280" alt="foto">
                    <div class="slider-gallery__hover"> <i class="icon icon-magnifier-add"></i>
                      <div class="slider-gallery__title">AUDI ABT S6</div>
                    </div>
                    </a> </div>
                  <div class="slider-gallery__item"> <a class="slider-gallery__link" href="https://www.youtube.com/watch?v=neS5h_VSvb8" rel="prettyPhoto"> <img class="img-responsive" src="img/4.jpg" height="177" width="280" alt="foto"> <i class="icon icon_video-link icon-control-play"></i>
                    <div class="slider-gallery__hover"></div>
                    </a> </div>
                  <div class="slider-gallery__item"> <a class="slider-gallery__link" href="img/1.jpg" rel="prettyPhoto"> <img class="" src="img/1.jpg" height="177" width="280" alt="foto">
                    <div class="slider-gallery__hover"> <i class="icon icon-magnifier-add"></i>
                      <div class="slider-gallery__title">AUDI ABT S6</div>
                    </div>
                    </a> </div>
                  <div class="slider-gallery__item"> <a class="slider-gallery__link" href="img/2.jpg" rel="prettyPhoto"> <img class="img-responsive" src="img/2.jpg" height="177" width="280" alt="foto">
                    <div class="slider-gallery__hover"> <i class="icon icon-magnifier-add"></i>
                      <div class="slider-gallery__title">AUDI ABT S6</div>
                    </div>
                    </a> </div>
                  <div class="slider-gallery__item"> <a class="slider-gallery__link" href="img/3.jpg" rel="prettyPhoto"> <img class="img-responsive" src="img/3.jpg" height="177" width="280" alt="foto">
                    <div class="slider-gallery__hover"> <i class="icon icon-magnifier-add"></i>
                      <div class="slider-gallery__title">AUDI ABT S6</div>
                    </div>
                    </a> </div>
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="clearfix">
              ...
              <a class="btn btn-success btn-effect pull-right" href="javascript:void(0);"><span class="btn-inner">READ BLOG</span></a> </div>
            <article class="post post_mod-a clearfix">
              <div class="entry-media"> <a href="img/a.jpg" rel="prettyPhoto"> <img class="img-responsive" src="img/a.jpg" width="470" height="280" alt="Foto"/>
              ...
              <div class="entry-main entry-main_mod-a">
                <div class="entry-main__inner entry-main__inner_mod-a">
                  <h3 class="entry-title"><a href="javascript:void(0);">adipisicing elit sed do eiusmod tempor sed incididunt</a></h3>
                  <div class="entry-meta"> <span class="entry-meta__item">By:: <a class="entry-meta__link" href="javascript:void(0);"> ALEX LEEMAN</a></span> <span class="entry-meta__item">COMMENTS :: <a class="entry-meta__link" href="javascript:void(0);">15</a></span> </div>
                </div>
                <div class="decor-1"></div>
                <div class="entry-date"><span class="entry-date__inner"><span class="entry-date__number">23</span><br>
                  SEP</span></div>
            ...
            <article class="post post_mod-a clearfix">
              <div class="entry-media"> <a href="img/b.jpg" rel="prettyPhoto"> <img class="img-responsive" src="img/b.jpg" width="470" height="280" alt="Foto"/>
                <div class="post-hover helper"><i class="icon icon-magnifier-add"></i></div>
                </a> </div>
              <div class="entry-main entry-main_mod-a">
                <div class="entry-main__inner entry-main__inner_mod-a">
                  <h3 class="entry-title"><a href="javascript:void(0);">sed rt enim ad minim veniam quis nostrud exercitation</a></h3>
                  <div class="entry-meta"> <span class="entry-meta__item">By:: <a class="entry-meta__link" href="javascript:void(0);"> ALEX LEEMAN</a></span> <span class="entry-meta__item">COMMENTS :: <a class="entry-meta__link" href="javascript:void(0);">15</a></span> </div>
                </div>
                <div class="decor-1"></div>
                <div class="entry-date"><span class="entry-date__inner"><span class="entry-date__number">21</span><br>
                  SEP</span></div>
                <div class="entry-content">
                  <p>Wliquam sit amet urna sed vel nullam semper aiber vestibulum fringilla orem ipsum dolor sit amet consectetur adipisicing elit sed don eiusmod tempor incididunt ut labore et dolore magna aliquaa enimd ad minim veniam quis nostrud.</p>
                </div>
            ...
            <article class="post post_mod-a clearfix">
              <div class="entry-media"> <a href="img/c.jpg" rel="prettyPhoto"> <img class="img-responsive" src="img/c.jpg" width="470" height="280" alt="Foto"/>
                <div class="post-hover helper"><i class="icon icon-magnifier-add"></i></div>
                </a> </div>
              <div class="entry-main entry-main_mod-a">
                <div class="entry-main__inner entry-main__inner_mod-a">
                ...
                <div class="decor-1"></div>
                <div class="entry-date"><span class="entry-date__inner"><span class="entry-date__number">09</span><br>
                  SEP</span></div>
                <div class="entry-content">
                  <p>Wliquam sit amet urna sed vel nullam semper aiber vestibulum fringilla orem ipsum dolor sit amet consectetur adipisicing elit sed don eiusmod tempor incididunt ut labore et dolore magna aliquaa enimd ad minim veniam quis nostrud.</p>
                </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="slider-reviews owl-carousel owl-theme owl-theme_mod-a enable-owl-carousel"
														data-min480="1"
														data-min768="2"
														data-min992="3"
														data-min1200="3"
                  ...
                  <div class="reviews">
                    ...
                    <div class="reviews__img"><img class="img-responsive" src="img/1.jpg" height="55" width="55" alt="avatar"></div>
                  ...
                  <div class="reviews">
                    ...
                    <div class="reviews__img"><img class="img-responsive" src="img/2.jpg" height="55" width="55" alt="avatar"></div>
                    <div class="reviews__inner">
                  ...
                  <div class="reviews">
                    ...
                    <div class="reviews__img"><img class="img-responsive" src="imgavatar_reviews/3.jpg" height="55" width="55" alt="avatar"></div>
                    <div class="reviews__inner">
    ...
    <section class="section_map section-bg-2 wow bounceInUp" data-wow-duration="2s">
      ...
      <!-- end container -->
      <div class="map"><img class="img-responsive" src="img/map.jpg" height="520" width="1600" alt="map"></div>
                ...
                <div class="col-xs-12">
                  ...
                  <div class="btn">
                    <div class="wrap__btn-skew-r">
                      <button class="btn-skew-r btn-effect "><span class="btn-skew-r__inner">send message</span></button>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <footer class="footer wow bounceInUp" data-wow-duration="2s">
            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <div class="footer__item"> <span class="footer__name">email:</span> <span class="footer__text">info@autozone.com</span> </div>
                  <div class="footer__item"> <span class="footer__name">Hours:</span> <span class="footer__text">Mon - Fri :: 9am - 6pm</span> </div>
                </div>
                <!-- end col --> 
              </div>
              <!-- end row -->
      ...
      <div class="copyright">Copyrights 2015 - 2016 <a class="copyright__link" href="javascript:void(0);">AutoZONE</a> : : All rights reserved</div>
    </footer>
  </div>
  <!-- end #wrapper --> 
</div>
